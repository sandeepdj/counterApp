...
angular.module('starter', ['ionic', 'starter.controllers', 'ngCordova', 'ionic-toast', 'ion-floating-menu'])
...
.config(function($stateProvider, $urlRouterProvider) {
    ...
    .state('app.accounts/:SaleHID', {
        url: '/accounts/:SaleHID',
        views: {
            'menuContent': {
